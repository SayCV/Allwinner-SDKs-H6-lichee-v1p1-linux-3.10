...
static const char lowmem_special_whitelist[][TASK_COMM_LEN] = {
	...
	".sh.playservice",  /* for cmcc com.chinamobile.sh.playservice*/
	"ethod.swpinyin2",  /* for cmcc net.sunniwell.inputmethod.swpinyin2*/
	"ade.chinamobile",  /* for cmcc net.sunniwell.service.swupgrade.chinamobile*/
	".swdevicemanger",  /* for cmcc com.shcmcc.swdevicemanger*/
	"com.cmcc.dlna",    /* for cmcc com.cmcc.dlna*/
	"e.controlserver",  /* for cmcc net.sunniwell.service.controlserver*/
};
static int lowmem_special_fixup(struct task_struct *p)
{
	...
	for (i = 0; i < ARRAY_SIZE(lowmem_special_whitelist); i++)
		if (strstr(p->comm, lowmem_special_whitelist[i]))
			goto ignore_kill_check;
