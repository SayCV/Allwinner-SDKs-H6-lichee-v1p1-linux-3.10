/*
 * linux-3.10/drivers/video/sunxi/disp2/disp/de/lowlevel_sun8iw11/de_peak.c
 *
...
static volatile __peak_reg_t *peak_dev[DE_NUM][CHN_NUM];
static de_reg_blocks peak_block[DE_NUM][CHN_NUM];
static de_reg_blocks peak_gain_block[DE_NUM][CHN_NUM];
