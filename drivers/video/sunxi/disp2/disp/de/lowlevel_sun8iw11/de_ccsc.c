/*
 * linux-3.10/drivers/video/sunxi/disp2/disp/de/lowlevel_sun8iw11/de_ccsc.c
 *
...
static volatile __csc_reg_t *ccsc_dev[DE_NUM][CHN_NUM];
static volatile __icsc_reg_t *icsc_dev[DE_NUM][CHN_NUM];
static de_reg_blocks csc_block[DE_NUM][CHN_NUM];
static de_reg_blocks icsc_block[DE_NUM][CHN_NUM];
