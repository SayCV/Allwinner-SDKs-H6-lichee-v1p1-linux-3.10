/*
 * linux-3.10/drivers/video/sunxi/disp2/disp/de/lowlevel_sun8iw11/de_fcc.c
 *
...
static volatile __fcc_reg_t *fcc_dev[DE_NUM][CHN_NUM];
static de_reg_blocks fcc_para_block[DE_NUM][CHN_NUM];
