/*
 * linux-3.10/drivers/video/sunxi/disp2/disp/de/lowlevel_sun8iw11/de_gsu.c
 *
...
static volatile __gsu_reg_t *gsu_dev[DE_NUM][UI_CHN_NUM];
static de_reg_blocks gsu_glb_block[DE_NUM][UI_CHN_NUM];
static de_reg_blocks gsu_out_block[DE_NUM][UI_CHN_NUM];
static de_reg_blocks gsu_scale_block[DE_NUM][UI_CHN_NUM];
static de_reg_blocks gsu_coeff_block[DE_NUM][UI_CHN_NUM];
