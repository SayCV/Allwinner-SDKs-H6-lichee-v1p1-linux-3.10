/*
 * linux-3.10/drivers/video/sunxi/disp2/disp/de/lowlevel_sun8iw11/de_fce.c
 *
...
static volatile __fce_reg_t *fce_dev[DE_NUM][CHN_NUM];

static de_reg_blocks fce_para_block[DE_NUM][CHN_NUM];
static de_reg_blocks fce_celut_block[DE_NUM][CHN_NUM];
static de_reg_blocks fce_hist_block[DE_NUM][CHN_NUM];
...
__hist_status_t *g_hist_status[DE_NUM][CHN_NUM];

//for ce
__ce_status_t *g_ce_status[DE_NUM][CHN_NUM];
static unsigned char *g_celut[DE_NUM][CHN_NUM];
static hist_data *hist_res[DE_NUM][CHN_NUM];
