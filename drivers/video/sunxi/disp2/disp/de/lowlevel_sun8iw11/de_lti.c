/*
 * linux-3.10/drivers/video/sunxi/disp2/disp/de/lowlevel_sun8iw11/de_lti.c
 *
...
static volatile __lti_reg_t *lti_dev[DE_NUM][CHN_NUM];
static de_reg_blocks lti_block[DE_NUM][CHN_NUM];
