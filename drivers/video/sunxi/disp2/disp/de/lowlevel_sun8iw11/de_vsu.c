/*
 * linux-3.10/drivers/video/sunxi/disp2/disp/de/lowlevel_sun8iw11/de_vsu.c
 *
...
static volatile __vsu_reg_t *vsu_dev[DE_NUM][VI_CHN_NUM];
static de_reg_blocks vsu_glb_block[DE_NUM][VI_CHN_NUM];
static de_reg_blocks vsu_out_block[DE_NUM][VI_CHN_NUM];
static de_reg_blocks vsu_yscale_block[DE_NUM][VI_CHN_NUM];
static de_reg_blocks vsu_cscale_block[DE_NUM][VI_CHN_NUM];
static de_reg_blocks vsu_yhcoeff0_block[DE_NUM][VI_CHN_NUM];
static de_reg_blocks vsu_yhcoeff1_block[DE_NUM][VI_CHN_NUM];
static de_reg_blocks vsu_yvcoeff_block[DE_NUM][VI_CHN_NUM];
static de_reg_blocks vsu_chcoeff0_block[DE_NUM][VI_CHN_NUM];
static de_reg_blocks vsu_chcoeff1_block[DE_NUM][VI_CHN_NUM];
static de_reg_blocks vsu_cvcoeff_block[DE_NUM][VI_CHN_NUM];
