/*
 * linux-3.10/drivers/video/sunxi/disp2/disp/de/lowlevel_sun8iw11/de_ase.c
 *
...
static volatile __ase_reg_t *ase_dev[DE_NUM][CHN_NUM];
static de_reg_blocks ase_block[DE_NUM][CHN_NUM];
