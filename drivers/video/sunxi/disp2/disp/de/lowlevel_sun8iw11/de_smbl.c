/*
 * linux-3.10/drivers/video/sunxi/disp2/disp/de/lowlevel_sun8iw11/de_smbl.c
 *
...
static volatile __smbl_reg_t *smbl_dev[DE_NUM];
static de_reg_blocks smbl_enable_block[DE_NUM];
static de_reg_blocks smbl_ctrl_block[DE_NUM];
static de_reg_blocks smbl_hist_block[DE_NUM];
static de_reg_blocks smbl_csc_block[DE_NUM];
static de_reg_blocks smbl_filter_block[DE_NUM];
static de_reg_blocks smbl_lut_block[DE_NUM];

static __smbl_status_t *g_smbl_status[DE_NUM];
static unsigned int smbl_frame_cnt[DE_NUM] = {0};
static unsigned short *pttab[DE_NUM];   //POINTER of LGC tab
