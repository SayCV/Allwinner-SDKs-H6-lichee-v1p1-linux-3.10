/*
 * linux-3.10/drivers/video/sunxi/disp2/disp/de/lowlevel_sun8iw11/de_rtmx.c
 *
...
static __rtmx_reg_t de200_rtmx[DE_NUM];

static de_reg_blocks glb_ctl_block[DE_NUM];

static de_reg_blocks vi_attr_block[DE_NUM][VI_CHN_NUM][LAYER_MAX_NUM_PER_CHN];//0x00~0xbc
static de_reg_blocks vi_fc_block[DE_NUM][VI_CHN_NUM];                         //0xc0~0xcc
static de_reg_blocks vi_haddr_block[DE_NUM][VI_CHN_NUM];                      //0xd0~0xe4
static de_reg_blocks vi_size_block[DE_NUM][VI_CHN_NUM];                       //0xe8~0xfc

static de_reg_blocks ui_attr_block[DE_NUM][CHN_NUM-VI_CHN_NUM][LAYER_MAX_NUM_PER_CHN];//0x00~0x7c
static de_reg_blocks ui_haddr_block[DE_NUM][CHN_NUM-VI_CHN_NUM];                      //0x80~0x84
static de_reg_blocks ui_size_block[DE_NUM][CHN_NUM-VI_CHN_NUM];                       //0x88

static de_reg_blocks bld_attr_block[DE_NUM];//0x00~0x40
static de_reg_blocks bld_ctl_block[DE_NUM]; //0x80~0x9c
static de_reg_blocks bld_ck_block[DE_NUM];  //0xb0~0xec
static de_reg_blocks bld_out_block[DE_NUM]; //0xfc
