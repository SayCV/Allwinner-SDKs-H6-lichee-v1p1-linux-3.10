/*
 * linux-3.10/drivers/video/sunxi/disp2/disp/de/lowlevel_sun8iw11/de_dcsc.c
 *
...
static volatile __csc_reg_t *dcsc_dev[DE_NUM];
static volatile __csc2_reg_t *dcsc2_dev[DE_NUM];
static de_reg_blocks dcsc_coeff_block[DE_NUM];
static de_reg_blocks dcsc_enable_block[DE_NUM];
static struct disp_csc_config g_dcsc_config[DE_NUM];

static unsigned int is_in_smbl[DE_NUM]; //device csc and smbl in the same module or not
