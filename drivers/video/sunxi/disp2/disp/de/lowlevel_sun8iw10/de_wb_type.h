/*
 * linux-3.10/drivers/video/sunxi/disp2/disp/de/lowlevel_sun8iw10/de_wb_type.h
 *
...
typedef struct
{
	...
	__wb_csc_coeff_reg_t	c00;//0x0100
	__wb_csc_coeff_reg_t	c01;//0x0104
	__wb_csc_coeff_reg_t	c02;//0x0108
	__wb_csc_const_reg_t	c03;//0x010C
	__wb_csc_coeff_reg_t	c10;//0x0110
	__wb_csc_coeff_reg_t	c11;//0x0114
	__wb_csc_coeff_reg_t	c12;//0x0118
	__wb_csc_const_reg_t	c13;//0x011C
	__wb_csc_coeff_reg_t	c20;//0x0120
	__wb_csc_coeff_reg_t	c21;//0x0124
	__wb_csc_coeff_reg_t	c22;//0x0128
	__wb_csc_const_reg_t	c23;//0x012C
