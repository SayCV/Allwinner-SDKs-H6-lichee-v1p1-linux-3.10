/*
 * drivers/video/sunxi/disp2/tv/tv_ac200/tv_ac200.c
 *
 * Copyright (c) 2007-2017 Allwinnertech Co., Ltd.
 * Author: zhengxiaobin <zhengxiaobin@allwinnertech.com>
 *
 * top entry file of ac200 driver.
 *
...
{
	return disp_sys_pin_set_state("ac200", (1 == bon) ? "ccir_clk_active"
							  : "ccir_clk_sleep");
}
...
static s32 tv_get_hpd_status(void)
{
	pr_debug("tv_get_hpd_status:you need support the switch!\n");
	return 0;
}
#endif
