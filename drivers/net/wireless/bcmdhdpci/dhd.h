...
#define MAX_RESCHED_CNT 600
	...
	KERNEL_VERSION(3, 18, 0) || defined(CONFIG_BCMDHDPCI_VENDOR_EXT))
#define WL_VENDOR_EXT_SUPPORT
#endif /* 3.13.0 <= LINUX_KERNEL_VERSION < 3.18.0 || CONFIG_BCMDHDPCI_VENDOR_EXT */
...
#ifndef CONFIG_BCMDHDPCI_CLM_PATH
#define CONFIG_BCMDHDPCI_CLM_PATH "/system/etc/wifi/bcmdhd_clm.blob"
#endif /* CONFIG_BCMDHDPCI_CLM_PATH */
