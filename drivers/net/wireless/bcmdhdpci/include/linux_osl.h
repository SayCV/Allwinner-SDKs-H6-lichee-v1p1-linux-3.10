...
/* register access macros */
#define PCIE_BARBASE_0	0x05600000
	...
	SELECT_BUS_READ(osh, \
		({ \
			...
			switch (sizeof(*(r))) { \
				...
				case sizeof(uint64):	__osl_v = readq((volatile uint64*)(r)); break;  \
			} \
			__osl_v; \
		}), \
		OSL_READ_REG(osh, r)) \
...
#define R_REG(osh, r) (\
	...
	switch (sizeof(*(r))) { \
				case sizeof(uint8):	sunxi_pcie_cutpage_base(PCIE_BARBASE_0); \
					__osl_v = readb((volatile uint8*)(r)); break; \
				case sizeof(uint16):	sunxi_pcie_cutpage_base(PCIE_BARBASE_0); \
					__osl_v = readw((volatile uint16*)(r)); break; \
				case sizeof(uint32):	sunxi_pcie_cutpage_base(PCIE_BARBASE_0); \
					__osl_v = readl((volatile uint32*)(r)); break; \
			} \
