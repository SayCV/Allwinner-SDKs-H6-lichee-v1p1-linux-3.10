...
#if (LINUX_VERSION_CODE <= KERNEL_VERSION(3,10,86)) && !defined(WITH_BACKPORTS)
//#include <net/cfg80211.h>
//enum wiphy_flags
...
#ifdef CFG80211_STA_PARAM_SUPPORT_CHANNEL
